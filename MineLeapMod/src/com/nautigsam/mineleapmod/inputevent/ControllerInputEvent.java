...
public abstract class ControllerInputEvent
{
	...
	{
		LogHelper.Info("ControllerInputEvent constructor params:( type: " + type + ", controllerNumber: " + controllerNumber + ", buttonNumber: " + buttonNumber + ", threshhold: " + threshold + ", deadzone: " + deadzone + ")");
		this.type = type;
