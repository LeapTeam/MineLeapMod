...
import com.nautigsam.mineleapmod.inputevent.AxisInputEvent;
...
import com.nautigsam.mineleapmod.helpers.McKeyBindHelper;
...
public class ControllerSettings
{
	...
	public static void setDefaultJoyBindingMap(int joyIndex, boolean updateWithConfigFile)
	{
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.jump", "Jump", new ButtonInputEvent(joyIndex, 0, 1),
						new int[] { McObfuscationHelper.keyCode(settings.keyBindJump) }, 0, EnumSet.of(
								ControllerBinding.BindingOptions.GAME_BINDING, ControllerBinding.BindingOptions.REPEAT_IF_HELD,
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.inventory", "Open inventory", new ButtonInputEvent(joyIndex, 3, 1),
						new int[] { McObfuscationHelper.keyCode(settings.keyBindInventory) }, 100, EnumSet.of(
								ControllerBinding.BindingOptions.GAME_BINDING, ControllerBinding.BindingOptions.CATEGORY_INVENTORY)));
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.attack", "Attack", new AxisInputEvent(joyIndex, 4, defaultAxisThreshhold
						* -1, defaultAxisDeadZone), new int[] { -100 }, 0, EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING,
						ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));

		joyBindingsMap.put(
				"joy.use",
				new ControllerBinding("joy.use", "Use", new AxisInputEvent(joyIndex, 4, defaultAxisThreshhold,
						defaultAxisDeadZone), new int[] { -99 }, 0, EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING,
						ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));

		joyBindingsMap.put(
				"joy.interact",
				new ControllerBinding("joy.interact", "Interact", new ButtonInputEvent(joyIndex, 2, 1),
						new int[] { -99 }, 0, EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));

		joyBindingsMap.put("joy.guiLeftClick",
				new ControllerBinding("joy.guiLeftClick", "Left click", new ButtonInputEvent(joyIndex, 0, 1),
						new int[] { -100 }, 0, EnumSet.of(ControllerBinding.BindingOptions.MENU_BINDING, ControllerBinding.BindingOptions.CATEGORY_UI)));
		...
		joyBindingsMap.put("joy.guiRightClick",
				new ControllerBinding("joy.guiRightClick", "Right click", new ButtonInputEvent(joyIndex, 2, 1),
						new int[] { -99 }, 0, EnumSet.of(ControllerBinding.BindingOptions.MENU_BINDING, ControllerBinding.BindingOptions.CATEGORY_UI)));

		joyBindingsMap.put(
				"joy.prevItem",
				new ControllerBinding("joy.prevItem", "Previous item", new ButtonInputEvent(joyIndex, 4, 1),
						new int[] { -199 }, 0,
						EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.sprint", "Sprint", new ButtonInputEvent(joyIndex, 9, 1),
						new int[] { Keyboard.KEY_LCONTROL }, 0, EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING,
								ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));

		joyBindingsMap.put(
				"joy.menu",
				new ControllerBinding("joy.menu", "Open menu", new ButtonInputEvent(joyIndex, 7, 1),
						new int[] { Keyboard.KEY_ESCAPE }, 0, EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING,
								ControllerBinding.BindingOptions.MENU_BINDING, ControllerBinding.BindingOptions.CATEGORY_MISC)));

		joyBindingsMap.put(
				"joy.shiftClick",
				new ControllerBinding("joy.shiftClick", "Shift-click", new ButtonInputEvent(joyIndex, 1, 1), new int[] {
						Keyboard.KEY_LSHIFT, -100 }, 0, EnumSet.of(ControllerBinding.BindingOptions.MENU_BINDING,
						ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_INVENTORY)));

		joyBindingsMap.put(
				"joy.cameraX+",
				new ControllerBinding("joy.cameraX+", "Look right", new AxisInputEvent(joyIndex, xAxisIndex + 2,
						defaultAxisThreshhold, defaultAxisDeadZone), null, 0, EnumSet.of(ControllerBinding.BindingOptions.GAME_BINDING,
						ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.cameraX-", "Look left", new AxisInputEvent(joyIndex, xAxisIndex + 2,
						...
						ControllerBinding.BindingOptions.GAME_BINDING, ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_GAMEPLAY)));
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.guiX+", "GUI right", new AxisInputEvent(joyIndex, xAxisIndex,
						defaultAxisThreshhold, defaultAxisDeadZone), null, 0, EnumSet.of(ControllerBinding.BindingOptions.MENU_BINDING,
						ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_UI)));

		joyBindingsMap.put(
				"joy.guiX-",
				new ControllerBinding("joy.guiX-", "GUI left", new AxisInputEvent(joyIndex, xAxisIndex,
						defaultAxisThreshhold * -1, defaultAxisDeadZone), null, 0, EnumSet.of(
						ControllerBinding.BindingOptions.MENU_BINDING, ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.CATEGORY_UI)));
		...
		joyBindingsMap.put(
				...
				new ControllerBinding("joy.closeInventory", "Close container", new ButtonInputEvent(joyIndex, 3, 1),
						new int[] { McObfuscationHelper.keyCode(settings.keyBindInventory) }, 100, EnumSet.of(
								ControllerBinding.BindingOptions.MENU_BINDING, ControllerBinding.BindingOptions.CATEGORY_INVENTORY)));

		joyBindingsMap.put(
				"joy.scrollDown",
				new ControllerBinding("joy.scrollDown", "Scroll down", new ButtonInputEvent(joyIndex, 5, 1),
						new int[] { -201 }, scrollDelay, EnumSet.of(ControllerBinding.BindingOptions.MENU_BINDING,
								ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.RENDER_TICK, ControllerBinding.BindingOptions.CATEGORY_UI)));

		joyBindingsMap.put(
				"joy.scrollUp",
				new ControllerBinding("joy.scrollUp", "Scroll up", new ButtonInputEvent(joyIndex, 4, 1),
						new int[] { -199 }, scrollDelay, EnumSet.of(ControllerBinding.BindingOptions.MENU_BINDING,
								ControllerBinding.BindingOptions.REPEAT_IF_HELD, ControllerBinding.BindingOptions.RENDER_TICK, ControllerBinding.BindingOptions.CATEGORY_UI)));
	...
	public static void setToggle(int joyIndex, String bindingKey, boolean b)
	{
		...
		if (b)
		{
			changed = binding.bindingOptions.add(ControllerBinding.BindingOptions.IS_TOGGLE);
		}
		else
		{
			changed = binding.bindingOptions.remove(ControllerBinding.BindingOptions.IS_TOGGLE);
		}
	...
	private static ControllerBinding getNextBinding(Iterator<Entry<String, ControllerBinding>> current,
			ControllerBinding.BindingOptions target)
	{
	...
	public static boolean checkIfDuplicateBinding(String bindingKey)
	{
		...
		for (Map.Entry<String, ControllerBinding> entry : joyBindingsMap.entrySet())
		{
			...
			{
				if ((b.bindingOptions.contains(ControllerBinding.BindingOptions.GAME_BINDING) && entry.getValue().bindingOptions.contains(ControllerBinding.BindingOptions.GAME_BINDING))
						|| (b.bindingOptions.contains(ControllerBinding.BindingOptions.MENU_BINDING) && entry.getValue().bindingOptions.contains(ControllerBinding.BindingOptions.MENU_BINDING)))
					return true;
			}
		}
